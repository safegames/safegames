...
In order to support loading of multiple wallets in safegames-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is safegames.cpp.
...
Changes to safegames.cpp
----------------------
safegames.cpp is the entry point into safegames-qt, and as such, will require some minor modifications to provide hooks for
