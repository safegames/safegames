Contributing to SAFEGAMES Core
============================

The SAFEGAMES Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SAFEGAMES Core project, and is not to be
confused with overall SAFEGAMES Network Protocol consensus changes.

Whether a pull request is merged into SAFEGAMES Core rests with the project merge
...
Patches that change SAFEGAMES consensus rules are considerably more involved than
...
Where a patch set proposes to change the SAFEGAMES consensus, it must have been
...
The project leader is the release manager for each SAFEGAMES Core release.
