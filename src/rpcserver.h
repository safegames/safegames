...
/**
 * SAFEGAMES RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzsgsseed(const UniValue& params, bool fHelp);
extern UniValue getzsgsseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzsgs(const UniValue& params, bool fHelp);
extern UniValue dzsgsstate(const UniValue& params, bool fHelp);
