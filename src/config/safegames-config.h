/* src/config/safegames-config.h.  Generated from safegames-config.h.in by configure.  */
/* src/config/safegames-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.safegames.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Safegames Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Safegames Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "safegames"
