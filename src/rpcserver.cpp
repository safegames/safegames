...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SAFEGAMES server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "SAFEGAMES server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SAFEGAMES features */
        {"safegames", "masternode", &masternode, true, true, false},
        {"safegames", "listmasternodes", &listmasternodes, true, true, false},
        {"safegames", "getmasternodecount", &getmasternodecount, true, true, false},
        {"safegames", "masternodeconnect", &masternodeconnect, true, true, false},
        {"safegames", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"safegames", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"safegames", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"safegames", "masternodecurrent", &masternodecurrent, true, true, false},
        {"safegames", "masternodedebug", &masternodedebug, true, true, false},
        {"safegames", "startmasternode", &startmasternode, true, true, false},
        {"safegames", "createmasternodekey", &createmasternodekey, true, true, false},
        {"safegames", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"safegames", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"safegames", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"safegames", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"safegames", "getmasternodescores", &getmasternodescores, true, true, false},
        {"safegames", "mnbudget", &mnbudget, true, true, false},
        {"safegames", "preparebudget", &preparebudget, true, true, false},
        {"safegames", "submitbudget", &submitbudget, true, true, false},
        {"safegames", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"safegames", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"safegames", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"safegames", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"safegames", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"safegames", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"safegames", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"safegames", "checkbudgets", &checkbudgets, true, true, false},
        {"safegames", "mnsync", &mnsync, true, true, false},
        {"safegames", "spork", &spork, true, true, false},
        {"safegames", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzsgsseed", &getzsgsseed, false, false, true},
        {"zerocoin", "setzsgsseed", &setzsgsseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzsgs", &searchdzsgs, false, false, true},
        {"zerocoin", "dzsgsstate", &dzsgsstate, false, false, true}
...
{
    return "> safegames-cli " + methodname + " " + args + "\n";
}
