...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SAFEGAMES Core"),
     ...
     * override -datadir in the safegames.conf file in the default data directory
     * (to be consistent with safegamesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
