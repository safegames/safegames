                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SAFEGAMES Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SAFEGAMES address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and safegames: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSGS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SAFEGAMES Core"), this);
    aboutAction->setStatusTip(tr("Show information about SAFEGAMES Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SAFEGAMES"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SAFEGAMES addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SAFEGAMES addresses"));
    ...
    openAction->setStatusTip(tr("Open a SAFEGAMES: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SAFEGAMES Core help message to get a list with possible SAFEGAMES command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SAFEGAMES Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SAFEGAMES network", "", count));
}
...
{
    QString strTitle = tr("SAFEGAMES Core"); // default title
