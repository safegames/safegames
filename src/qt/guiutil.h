...
/** Utility functions used by the SAFEGAMES Qt UI.
 */
namespace GUIUtil
{
...
// Render SAFEGAMES addresses in monospace font
...
// Parse "safegames:" URI into recipient object, return true on successful parsing
