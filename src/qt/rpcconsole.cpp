                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSGSPathCustom = GetArg("-zsgsbackuppath", "");
    ...
    if(!strzSGSPathCustom.empty()) {
        ui->wallet_customzsgsbackuppath->setText(QString::fromStdString(strzSGSPathCustom));
        ui->wallet_customzsgsbackuppath_label->setVisible(true);
        ui->wallet_customzsgsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSGSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SAFEGAMES RPC console.") + "<br>" +
