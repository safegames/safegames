...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Safegames Core safegames-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  safegames-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded safegames transaction") + "\n" +
                               "  safegames-tx [options] -create [commands]   " + _("Create hex-encoded safegames transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded safegames transaction
