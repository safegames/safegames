...
#   c) node1 mines 32 blocks, so now node 0 has 60001sgs, node 1 has 4250sgs, node2 has none.
#   d) node0 sends 601 sgs to node2, in two transactions (301 sgs, then 300 sgs).
